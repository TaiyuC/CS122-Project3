...
#        self.exits = [False, False, False, False]
        self.items = []
        self.types = random.choice(["forest", "dessert", "montain"]) if types == None else types # 5 types of room: forest, dessert, montain, town(hp recover, no monster), palace(boss). 
